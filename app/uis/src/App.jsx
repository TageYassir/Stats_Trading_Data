...
export default function App() {
  ...
  const navItems = [
    ...
    { id: 'prediction', label: '5. Prediction Engine', color: '#ec4899' }
  ];
        ...
        >
          <div
            style={{
              ...
              height: '8px',
              borderRadius: '50%',
              backgroundColor: status === 'ok' ? '#10b981' : '#ef4444'
            }}
          ></div>
        ...
        {navItems.map((tab) => (
          <button
            ...
            style={{
              ...
              border: '1px solid',
              borderColor:
                activeTab === tab.id ? '#334155' : 'transparent',
              borderRadius: '8px',
              color:
                activeTab === tab.id ? tab.color : '#64748b',
              fontSize: '15px',
              fontWeight: '600',
              cursor: 'pointer',
